/**
 * This is a fork of the activity-detector module at
 * https://github.com/tuenti/activity-detector
 * but moves reading the `document` global from the main
 * body of the module into the activityDetector function
 * so that this can be used in server-side rendering.
 * See this issue: https://github.com/tuenti/activity-detector/issues/10
 */
const ACTIVE = 'active'
const IDLE = 'idle'
